...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-cordova/node_modules/cordova-common/src/CordovaLogger.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-cordova/node_modules/cordova-common/src/CordovaLogger.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-cordova/node_modules/cordova-common/src/</a> &#187; CordovaLogger.js</div>
</div>
<div class="body">
 ...
 */
CordovaLogger.prototype.log = <span class="fstat-no" title="function not covered" >function (logLevel, message) {</span>
...
<span class="cstat-no" title="statement not covered" >    if (!this.levels[logLevel] || this.levels[logLevel] &lt; this.levels[this.logLevel])</span>
        // return instance to allow to chain calls
<span class="cstat-no" title="statement not covered" >        return this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var isVerbose = this.logLevel === 'verbose';</span>
<span class="cstat-no" title="statement not covered" >    var cursor = this.stdoutCursor;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (message instanceof Error || logLevel === CordovaLogger.ERROR) {</span>
<span class="cstat-no" title="statement not covered" >        message = formatError(message, isVerbose);</span>
<span class="cstat-no" title="statement not covered" >        cursor = this.stderrCursor;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var color = this.colors[logLevel];</span>
<span class="cstat-no" title="statement not covered" >    if (color) {</span>
<span class="cstat-no" title="statement not covered" >        cursor.bold().fg[color]();</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    cursor.write(message).reset().write(EOL);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
};
&nbsp;
 ...
 * @return  {CordovaLogger}     Current instance, to allow calls chaining.
 */
CordovaLogger.prototype.subscribe = <span class="fstat-no" title="function not covered" >function (eventEmitter) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!(eventEmitter instanceof EventEmitter))</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    eventEmitter.on('verbose', this.verbose)</span>
        .on('log', this.normal)
        .on('info', this.info)
        .on('warn', this.warn)
...
&nbsp;
<span class="fstat-no" title="function not covered" >function formatError(error, isVerbose) {</span>
<span class="cstat-no" title="statement not covered" >    var message = '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (error instanceof CordovaError) {</span>
<span class="cstat-no" title="statement not covered" >        message = error.toString(isVerbose);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof message === 'string' &amp;&amp; message.toUpperCase().indexOf('ERROR:') !== 0) {</span>
